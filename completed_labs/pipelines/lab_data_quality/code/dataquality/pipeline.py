...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/lab_data_quality")
    registerUDFs(spark)
    
    MetricsCollector.instrument(spark = spark, pipelineId = "pipelines/lab_data_quality", config = Config)(pipeline)
